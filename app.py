...
st.markdown("""
    <div style='text-align: center; margin-top: 20px;'>
        ...
        <p style='font-size: 18px;'><a href='https://github.com/geonik71/Eutectic-Phase-Analysis' target='_blank' style='text-decoration: none; font-weight: bold; color: #0366d6;'>Click here to star!</a> ⭐</p>
    </div>
